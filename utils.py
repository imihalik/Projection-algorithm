async def _merge_event_streams(  # noqa: C901
      self,
      ...
      try:
          ...
          while True:
              try:
                  if timed_out:
                      ...
                      # First time running an iteration of `adapter_stream`. It may time out.
          ...
          task.cancel()
          # Wait for the task to pick up the cancellation request and do get cancelled.
